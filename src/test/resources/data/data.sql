alter table support_address change cn_name cn_name varchar (32) character set utf8;
-- address data
...
alter table house change title title varchar (32) character set utf8;
alter table house change district district varchar (32) character set utf8;
alter table house change street street varchar (32) character set utf8;
-- house data
...
alter table house_detail change description description varchar (32) character set utf8;
alter table house_detail change layout_desc layout_desc varchar (32) character set utf8;
alter table house_detail change traffic traffic varchar (32) character set utf8;
alter table house_detail change round_service round_service varchar (32) character set utf8;
alter table house_detail change address address varchar (32) character set utf8;
alter table house_detail change subway_line_name subway_line_name varchar (32) character set utf8;
alter table house_detail change subway_station_name subway_station_name varchar (32) character set utf8;
-- house_detail data
...
alter table house_tag change name name varchar (32) character set utf8;
-- house tag data
